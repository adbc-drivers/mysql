...
require (
	github.com/adbc-drivers/driverbase-go/driverbase v0.0.0-20260614225341-e29629f90ef8
	github.com/adbc-drivers/driverbase-go/sqlwrapper v0.0.0-20260614225341-e29629f90ef8
